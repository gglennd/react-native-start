  ...
  return (
    <GBottomSheetTextInput
      ...
      className={cn(
        ...
        'h-14 items-center rounded-md border border-input bg-background px-3 text-xl leading-[1.25] text-muted-foreground disabled:opacity-50',
        className
      )}
  ...
  return (
    ...
    >
      ...
      <Button onPress={close} variant='ghost' className='pr-4'>
        <IconX className='text-muted-foreground' size={24} />
      </Button>
    </View>
  );
});
