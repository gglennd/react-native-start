...
import {
  ...
  useBottomSheet
} from '~/components/depecrated-ui/bottom-sheet';
import {
  Button,
  buttonTextVariants,
  buttonVariants
} from '~/components/depecrated-ui/button';
import { IconCheck, IconChevronsUpDown, IconSearch } from '~/lib/icons';
...
>(
  (
    ...
    const onItemChange = React.useCallback(
      ...
      [selectedItemProp?.value, setSearch, bottomSheet] // Dependencies
    );
      ...
      ({ item }: ListRenderItemInfo<unknown>) => {
        ...
        return (
          ...
          >
            ...
            {isSelected && (
              <IconCheck size={24} className={'mt-1.5 px-6 text-foreground'} />
            )}
          </Button>
        );
      },
      ...
      <BottomSheet>
        ...
        >
          <View className='flex-1 flex-row justify-between'>
            ...
            <IconChevronsUpDown className='ml-2 text-foreground opacity-50' />
          </View>
        </BottomSheetOpenTrigger>
        <BottomSheetContent
          ref={bottomSheet.ref}
        ...
        >
          ...
          <View className='relative border-b border-border px-4 pb-4'>
            ...
            >
              <IconSearch size={18} className='text-foreground opacity-50' />
            </Button>
          </View>
          <BottomSheetFlatList
            data={listItems}
