...
import { IconAlertTriangle, IconCheckSquare, IconInfo } from '~/lib/icons';
/**
...
const TOAST_CONFIG: ToastConfig = {
  success: ({ text1, text2, onPress, props: { icon = IconCheckSquare } }) => (
  ...
  error: ({ text1, text2, onPress, props: { icon = IconAlertTriangle } }) => (
    <Pressable onPress={onPress} className='w-full max-w-xl px-6'>
  ...
  base: ({ text1, text2, onPress, props: { icon = IconInfo } }) => (
    <Pressable onPress={onPress} className='w-full max-w-xl px-6'>
